...
(function (global, factory) {
  ...
  (global = global || self, global.Ckey = factory());
	...
	var videoObjectDefault= {
		...
		title:'',//视频标题
		language:'',//语言包文件
		barHideTime:1800,//控制栏隐藏时间
		playbackrateOpen:false,//是否开启控制栏倍速选项
...
/*			{
		...
		*/
		hlsPlayer=function (url){
			var path='//lib.baomitu.com/hls.js/latest/hls.min.js';
			loadJs(path,function(){
		...
		*/
		flvPlayer=function (url){
			var path='//lib.baomitu.com/flv.js/1.6.2/flv.min.js';
			loadJs(path,function(){
		...
		*/
		mpegtsPlayer=function (url){
			var path='//xqq.im/mpegts.js/dist/mpegts.js';
			loadJs(path,function(){
